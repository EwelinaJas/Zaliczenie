<!--Tutaj mamy umieszczoną walidację poprawności adresu e-mail, połączenie z bazą danych oraz 
zapis wprowadzonych danych w tabeli 'users'  -->
...
<body>
    ...
    <div class="container">
        ...
        <header>
            <h1>Newsletter - możliwość zapisu !</h1>
        </header>
